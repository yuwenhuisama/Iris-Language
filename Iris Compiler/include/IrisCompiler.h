...
public:
	...
	//unsigned int GetStringIndex(const string& strString, const string&  strFileName);
	//unsigned int GetIntegerIndex(int nInteger, const string&  strFileName);
	//unsigned int GetFloatIndex(double dFloat, const string&  strFileName);
	//unsigned int GetIdentifierIndex(const string& strIdentifier, const string&  strFileName);
	//unsigned int GetUniqueStringIndex(const string& strString, const string&  strFileName);

	//unsigned int GetFileIndex(const string& strFileName);
	...
	//inline const string& GetString(unsigned int nIndex, const string& strFileName) {
	//	auto pData = m_mpStatementInfos[strFileName];
	//	return pData->m_pStringSpace->at(nIndex);
	//}
	//inline int GetInteger(unsigned int nIndex, const string& strFileName) {
	//	auto pData = m_mpStatementInfos[strFileName];
	//	return pData->m_pIntegerSpace->at(nIndex);
	//}
	//inline double GetFloat(unsigned int nIndex, const string& strFileName) {
	//	auto pData = m_mpStatementInfos[strFileName];
	//	return pData->m_pFloatSpace->at(nIndex);
	//}
	//inline const string& GetIdentifier(unsigned int nIndex, const string& strFileName) {
	//	auto pData = m_mpStatementInfos[strFileName];
	//	return pData->m_pIdentifierSpace->at(nIndex);
	//}
	//inline const string& GetUniqueString(unsigned int nIndex, const string& strFileName) {
	//	auto pData = m_mpStatementInfos[strFileName];
	//	return pData->m_pUniqueStringSpace->at(nIndex);
	//}
