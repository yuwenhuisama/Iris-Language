...
IrisValue IrisMethod::Call(IrisValue& ivObject, IrisContextEnvironment* pContextEnvironment ,IrisValues* pParameters, unsigned int nLineNumber, int nBelongingFileIndex) {
	...
	//}
	//else if (IrisInterpreter::CurrentInterpreter()->GetMainClosureBlock()) {
	//	pNewEnvironment->m_pClosureBlock = IrisInterpreter::CurrentInterpreter()->GetMainClosureBlock();
	//	IrisInterpreter::CurrentInterpreter()->SetMainClosureBlock(nullptr);
	//}
