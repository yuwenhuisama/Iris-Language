...
| `IRIS-V1-RUNTIME-V107` | `:627` | negative | needs-subsystem | Re-probed in milestone 2. Contract declarations, conformance and qualified dispatch all exist now; what remains is `Dynamic<T>` construction and its return-Contract enforcement, which do not parse. |
