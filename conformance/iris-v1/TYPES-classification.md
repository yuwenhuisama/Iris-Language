...
| `V225` | positive | executable | `IRIS-V1-TYPES-C037` makes a parameter CONTRAVARIANT and a return COVARIANT. The row's bare arrow annotation has no production, which is recorded as a defect. |
