...
IrisValue IrisGCModule::ForceStart(const IrisValue & ivObj, IIrisValues * ivsValues, IIrisValues * ivsVariableValues, IIrisContextEnvironment * pContextEnvironment) {
	IrisGC::CurrentGC()->ForceStart();
	return IrisInterpreter::CurrentInterpreter()->Nil();
}

IrisValue IrisGCModule::SetFlag(const IrisValue & ivObj, IIrisValues * ivsValues, IIrisValues * ivsVariableValues, IIrisContextEnvironment * pContextEnvironment) {
