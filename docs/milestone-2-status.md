...
```
COLLECTIONS passed: 116, failed: 0, needs_subsystem: 0, no_fixture: 0, differential: 0 (116 records, buckets sum 116)
FFI         passed: 30, failed: 0, needs_subsystem: 1, no_fixture: 0, differential: 0   (31 records, buckets sum 31)
...
**612 of 624 spec rows transcribed (98.1%), plus 14 locally authored rows.**

Transcribed is not the same as passing. Of the 626 records in the corpus, 592
...
- `COLLECTIONS`: `V039` `V295` `V296` `V297` `V330` `V350`
- `IDENTITY`: `V002` `V014`
