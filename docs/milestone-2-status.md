...
**Revision:** Iris v1.12 (frozen semantics with owner-approved errata)
**Branch:** `new-iris-dev`
...
```
RUNTIME  passed: 76, failed: 3, needs_subsystem: 9, no_fixture: 18, differential: 3   (109 records, buckets sum 109)
GRAMMAR  passed: 26, failed: 0, deferred: 1, authored_expect: 5, unrunnable_source: 9  (41 records)
```

Milestone 2 opened at RUNTIME 41 and closed at 76.
...
Milestone 2 is closed as delivered at 76 of the 79 runnable RUNTIME vectors. None of the three
...
`docs/spec-defects-v1.md` holds 43 rows, 26 resolved, and records the blocker for every one.
...
**Milestone 2 is closed as delivered.** RUNTIME conformance advanced from 41 to 76 across the
